...
export async function saveTranscriptIfRetained({ attemptId, orgId, userId, messages }) {
...
export async function getTranscript(attemptId, orgId, userId) {
  const db = getSupabaseScoped(orgId, userId)
...
export async function markReviewedAndPurgeIfDue(attemptId, orgId, userId) {
  const db = getSupabaseScoped(orgId, userId)
