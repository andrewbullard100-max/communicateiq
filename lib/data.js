...
export const MODULES = [
  { id: 'diagnostic',   href: '/diagnostic',   icon: '📋', label: 'Pre-Course Diagnostic',    day: 'Start Here',  desc: 'Self-assessment to personalize your learning path', badge: { text: 'START HERE', bg: '#1C2B5E' } },
  ...
  { id: 'financial',    href: '/financial',    icon: '📊', label: 'Financial Storytelling',   day: 'Financial Fluency', desc: 'Translate P&L into executive language' },
  ...
  { id: 'policies',   href: '/admin?tab=policies', icon: '📑', label: 'Upload Your Policies', day: 'Personalize', desc: 'Upload your policies & procedures — AI builds custom scenarios and coaching grounded in your own language', badge: { text: 'BUILD YOUR OWN', bg: '#0D9488' }, contentRoleOnly: true },
  { id: 'admin',      href: '/admin',     icon: '⚙️', label: 'Admin Console',     day: 'Org Admin',  desc: 'Manage users, roles, billing, and sign-in activity for your organization', orgAdminOnly: true },
