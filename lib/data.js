...
// ─── Leadership & Operations Scenarios ──────────────────────────────────────
// Separate from SCENARIOS above: those are the GM talking UP/OUT to client
// stakeholders. These are the GM talking DOWN/ACROSS — to their own team,
// supervisors, and vendors — about labor cost, raw material cost, and
// running operations through other people. Same shape as SCENARIOS except
// the persona field is named `counterpartPersona` (an employee/supervisor/
// vendor, not a client) to keep the two content sets clearly distinct in
// code even though the underlying engine (buildSystemPrompt, scoring) is shared.
// 8 scenarios × 5 industries = 40. trainingType values used:
